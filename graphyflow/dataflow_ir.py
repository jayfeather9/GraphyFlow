...
class ReduceComponent(Component):
    ...
    def to_hls_list(
        ...
        code_in_loop = [
            ...
            r"    key_mem[real_reduce_key_out#may_ele:i_reduce_key_out#].valid.ele = 1;",
            r"    key_mem[real_reduce_key_out#may_ele:i_reduce_key_out#].key = real_reduce_key_out;",
            r"    key_mem[real_reduce_key_out#may_ele:i_reduce_key_out#].data = real_reduce_transform_out;",
            r"} else {",
            '        hls::stream<#type:o_reduce_unit_start_0#> reduce_unit_stream_0("reduce_unit_stream_0");',
            ...
            r"        #type:i_reduce_unit_end# reduce_unit_out = #read:reduce_unit_stream_out#;",
            r"        #peel:i_reduce_unit_end,reduce_unit_out,real_reduce_unit_out#",
            r"        key_mem[real_reduce_key_out#may_ele:i_reduce_key_out#].data = real_reduce_unit_out;",
            r"}",
        ]
        code_after_loop = [
            # r"#output_length# = 0;",
