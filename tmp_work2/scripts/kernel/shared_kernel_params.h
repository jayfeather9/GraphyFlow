...
#define MAX_LITTLE_MERGER_LENGTH 6
#define MAX_BIG_MERGER_LENGTH 3
...
extern "C" void
big_merger_0(hls::stream<write_burst_pkt_t> &big_kernel_1_out_stream,
...
extern "C" void
little_merger_1(hls::stream<little_out_pkt_t> &little_kernel_1_out_stream,
                ...
                hls::stream<write_burst_pkt_t> &kernel_out_stream);
extern "C" void
little_merger_2(hls::stream<little_out_pkt_t> &little_kernel_1_out_stream,
                hls::stream<little_out_pkt_t> &little_kernel_2_out_stream,
                hls::stream<little_out_pkt_t> &little_kernel_3_out_stream,
                hls::stream<little_out_pkt_t> &little_kernel_4_out_stream,
                hls::stream<little_out_pkt_t> &little_kernel_5_out_stream,
