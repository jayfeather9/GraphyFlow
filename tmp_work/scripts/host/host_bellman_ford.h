...
// This function performs a single iteration of the Bellman-Ford algorithm on the host CPU.
// It returns true if any distance value was updated, false otherwise.
