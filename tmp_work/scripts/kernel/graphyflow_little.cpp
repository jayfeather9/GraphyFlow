...
static void Reduc_105_unit_reduce(hls::stream<struct_kbu_50_t> &in_kt_pair_stream, hls::stream<internal_end_data_batch_t> &o_0) {
    ...
    struct_nb_58_t key_mem[PE_NUM][MAX_NUM];
...
#pragma HLS UNROLL
                ...
                if (old_ele.ele_1) {
                    ...
                    temp_Scatt_224_o_0 = pe_val.prop;
                    ...
                    // Inlining Gathe_208
                    new_ele.ele_0.prop = fused_temp_BinOp_96_o_0;
                    new_ele.ele_0.node_id = temp_Scatt_220_o_1;
...
#pragma HLS PIPELINE
        node_with_prop_t final_value;
        bool is_valid_addr = false;
        LOOP_FOR_88:
        for (uint32_t pe = 0; pe < PE_NUM; pe++) {
#pragma HLS UNROLL
            struct_nb_58_t partial_result;
            ...
            if (partial_result.ele_1) {
                if ((!is_valid_addr)) {
                    ...
                    node_with_prop_t partial_data;
                    partial_data = partial_result.ele_0;
                    // -- Inline sub graph --
                    // Inlining Scatt_220
                    ap_fixed_pod_t temp_Scatt_220_o_0;
                    node_id_t temp_Scatt_220_o_1;
                    temp_Scatt_220_o_0 = final_value.prop;
                    temp_Scatt_220_o_1 = final_value.node_id;
                    // Inlining Scatt_224
                    ap_fixed_pod_t temp_Scatt_224_o_0;
                    node_id_t temp_Scatt_224_o_1;
                    temp_Scatt_224_o_0 = partial_data.prop;
                    // Inlining fused_op_214
                    // -- Begin Nested Inline for FusedOp fused_op_214 --
                    // Inlining BinOp_96
                    ap_fixed_pod_t fused_temp_BinOp_96_o_0;
                    ...
                    fused_temp_BinOp_96_o_0 = *reinterpret_cast<int32_t*>(&temp_BinOp_96_o_0_ap_result);
                    // Inlining Gathe_208
                    final_value.prop = fused_temp_BinOp_96_o_0;
                    final_value.node_id = temp_Scatt_220_o_1;
                    // -- End Nested Inline for FusedOp fused_op_214 --
                    // -- Inline sub graph end --
                }
            }
